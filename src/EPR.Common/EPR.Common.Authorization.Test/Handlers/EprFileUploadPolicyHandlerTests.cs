...
[TestClass]
public class EprFileUploadPolicyHandlerTests
    : PolicyHandlerTestsBase<EprFileUploadPolicyHandler<MySession>, EprFileUploadPolicyRequirement, MySession>
{
    [TestInitialize]
    ...
    public async Task FileUpload_IsAuthorised_WhenUserHasRolesInClaim(string serviceRole, string roleInOrganisation, string enrolmentStatus) =>
    ...
    public async Task FileUpload_IsNotAuthorised_WhenUserIsNotAuthenticated(string serviceRole, string roleInOrganisation, string enrolmentStatus) =>
    ...
    public async Task FileUpload_IsNotAuthorised_WhenUserDataExistsInClaimButUserServiceRoleIsNotValid(string serviceRole, string roleInOrganisation, string enrolmentStatus) =>
    ...
    [TestMethod]
    public async Task FileUpload_IsNotAuthorised_WhenAuthorizationHandlerContextResourceDoesNotExist() =>
    ...
    [DataRow(ServiceRoles.BasicUser, RoleInOrganisation.NotSet, EnrolmentStatuses.Approved)]
    [DataRow(ServiceRoles.BasicUser, RoleInOrganisation.Admin, EnrolmentStatuses.Approved)]
    public async Task FileUpload_IsAuthorised_WhenCacheContainRequiredUserData(string serviceRole, string roleInOrganisation, string enrolmentStatus) =>
    ...
    [DataRow(ServiceRoles.RegulatorAdmin, RoleInOrganisation.Admin, EnrolmentStatuses.Approved)]
    [DataRow(ServiceRoles.RegulatorAdmin, RoleInOrganisation.Employee, EnrolmentStatuses.Approved)]
    public async Task FileUpload_IsNotAuthorised_WhenUserDataExistsInCacheButUserServiceRoleIsNotValid(string serviceRole, string roleInOrganisation, string enrolmentStatus) =>
    ...
    [DataRow(ServiceRoles.BasicUser, RoleInOrganisation.NotSet, EnrolmentStatuses.Approved)]
    [DataRow(ServiceRoles.BasicUser, RoleInOrganisation.Admin, EnrolmentStatuses.Approved)]
    public async Task FileUpload_IsAuthorised_WhenClaimsComeFromFromApi(string serviceRole, string roleInOrganisation, string enrolmentStatus) =>
    ...
    [DataRow(ServiceRoles.RegulatorAdmin, RoleInOrganisation.Admin, EnrolmentStatuses.Approved)]
    [DataRow(ServiceRoles.RegulatorAdmin, RoleInOrganisation.Employee, EnrolmentStatuses.Approved)]
    public async Task FileUpload_IsNotAuthorised_WhenUserDataIsRetrievedFromApiButUserServiceRoleIsNotValid(string serviceRole, string roleInOrganisation, string enrolmentStatus) =>
