...
[TestClass]
public class EprSelectSchemePolicyHandlerTests
    : PolicyHandlerTestsBase<EprSelectSchemePolicyHandler<MySession>, EprSelectSchemePolicyRequirement, MySession>
{
    [TestInitialize]
